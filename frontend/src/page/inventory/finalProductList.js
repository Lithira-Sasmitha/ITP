...
const finalProducts = [
  { name: "Coconut Shell Crafts", quantity: 150, supplier: "supplier1@email.com" },
  { name: "Coir Mats", quantity: 70, supplier: "supplier2@email.com" },
  { name: "Coconut Fiber Bags", quantity: 40, supplier: "supplier3@email.com" },
];

const lowStockThreshold = 50; // Set low stock threshold for final products
...
const ViewFinalProducts = () => {
  ...
  const lowStockMaterials = finalProducts.filter((item) => item.quantity < lowStockThreshold);
    ...
    <WarehouseLayout>
      ...
      <div className="flex flex-col p-3 mb-6 text-white bg-red-600 shadow-xl rounded-xl animate__animated animate__bounceIn">
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-lg">If you want to reorder this final product, click the <span className="underline">Send Email</span> button to contact the supplier directly.</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-4 ">
        ...
        <div className="p-6 text-green-900 transition duration-300 transform bg-green-200 rounded-lg shadow-xl hover:-translate-y-1 hover:shadow-2xl">
          ...
          <p className="text-2xl">{[...new Set(finalProducts.map((item) => item.supplier))].length}</p>
        </div>
        <div className="p-6 text-green-900 transition duration-300 transform bg-green-200 rounded-lg shadow-xl hover:-translate-y-1 hover:shadow-2xl">
      ...
      <div className="flex flex-col items-center p-6 bg-white rounded-lg shadow-xl">
        ...
        <div className="w-full">
          <h3 className="mb-4 text-lg font-semibold text-center">Final Product Distribution</h3>
