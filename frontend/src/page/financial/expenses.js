  ...
  return (
    <div className="flex h-screen bg-gray-150">
        ...
        <div>
          ...
          <nav>
            <ul>
              ...
              <li className="mb-4">
                <button onClick={() => navigate("/expenses")} className="flex items-center w-full p-3 rounded-lg  bg-red-600 hover:bg-red-500">
      ...
      <div className="flex-grow p-8">
        <h1 className="text-2xl font-bold mb-6">Expences</h1>
