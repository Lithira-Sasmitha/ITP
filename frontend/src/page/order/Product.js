...
import { useNavigate } from "react-router-dom"; // For navigating to the placeorder page
...
const Product = () => {
  ...
  const products = [
    {
      ...
      price: 15,
      imageUrl: "https://via.placeholder.com/150?text=Coco+Peat+Block",
    },
    {
      name: "Coir Fiber Brick",
      price: 25,
      imageUrl: "https://via.placeholder.com/150?text=Coir+Fiber+Brick",
    },
    {
      name: "Coconut Husk Chips",
      price: 35,
      imageUrl: "https://via.placeholder.com/150?text=Coconut+Husk+Chips",
    },
  ];
  ...
  const handleCheckout = () => {
    // Navigate to the PlaceOrder page and pass cartItems and delivery price as state
    const deliveryPrice = 5; // Example fixed delivery price
